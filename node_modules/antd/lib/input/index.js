...
var Input = function (_React$Component2) {
  ...
  _createClass(Input, [{
    ...
    value: function renderLabledInput(children) {
      ...
      var className = (0, _classnames2.default)((_classNames2 = {}, _defineProperty(_classNames2, props.prefixCls + '-input-wrapper', true), _defineProperty(_classNames2, wrapperClassName, addonBefore || addonAfter), _classNames2));
      return _react2.default.createElement(
        'span',
        { className: className },
        addonBefore,
